...
python scripts\db_backfill_fandom_story_arcs.py --db database/database.db
python scripts\db_validate.py --db database/database.db
...
Restore the backup written next to `database/database.db` before the backfill.
...
```powershell
python scripts\db_normalize_story_arc_ids.py --db database/database.db --dry-run
python scripts\db_normalize_story_arc_ids.py --db database/database.db
python scripts\db_validate.py --db database/database.db
...
```powershell
python scripts\db_normalize_issue_ids.py --db database/database.db --dry-run
python scripts\db_normalize_issue_ids.py --db database/database.db
python scripts\db_validate.py --db database/database.db
