...
```powershell
python scripts\db_init.py --db database.db
...
python scripts\db_export_run_checklist.py --db database.db --priority P1
```
...
python scripts\db_import_json.py --db database.db
