...
```powershell
python scripts\db_init.py --db projects/spider-man/database/database.db
...
python scripts\db_export_run_checklist.py --db projects/spider-man/database/database.db --priority P1
```
...
python scripts\db_import_json.py --db projects/spider-man/database/database.db
...
Point `projects/spider-man/config.json` at the SQLite database:
